		...
		<ul class="navbar-nav ml-auto">
			...
			<li class="nav-item">
					<form method="post" action="login.php" >
				      	...
				      	<div class="container">
				        				<a href="orgentitylogin.php" class="btn btn-info btn-md" class="nav-link px-lg-5 link-nav-index font-weight-bold">
				          					 Log out
				        				</a>
				      	</div>
...
<center>
	...
	?><br>
	<h1 style="text-align: center ;color:#000066;">Welcome <?php echo " ,"?><?php echo $_SESSION['ufirstname'];?><?php echo " "?><?php echo $_SESSION['ulastname'];?>(Organization) <?php echo " "?>to Caramel IT Academy! </h1>
</div>
</body>
