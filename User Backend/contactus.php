	...
	<div >
		...
		<div class="contai">
			<nav class="navbar navbar-expand-lg bg-light navbar-light">
				<!-- Brand-->
				<a class="navbar-brand" href="../index.html"><img src="Caramel-Horz.png" width="200px" height="70px"></a>
				...
				<div class="collapse navbar-collapse" id="collapsibleNavbar">
					<ul class="navbar-nav ml-auto font-weight-bold">
						...
						<li class="nav-item">
							<a class="nav-link px-lg-4" href="contactus.php">Contact Us</a>
						</li>
					</ul>
				</div>
			</nav>
		...
		<div class="row">
			...
			<div class="col-lg-10 contact">
				...
				<div class="col-lg-4">
				 ...
				 <div class="form-group" >
                            <button value="submit" class="csub">SUBMIT</button>
