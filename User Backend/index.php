		...
		<ul class="navbar-nav ml-auto">
			...
			<li class="nav-item">
					<form method="post" action="login.php" >
				      	...
				      	<div class="container">
				        				<a href="login.php" class="btn btn-info btn-md" class="nav-link px-lg-5 link-nav-index font-weight-bold">
				          					 Log out
				        				</a>
				      	</div>
...
<center>
	...
	<?php
	session_start();
	if(isset($_SESSION['uemail'])&&isset($_SESSION['utype'])&&isset($_SESSION['ufirstname'])&&isset($_SESSION['ulastname'])){
		echo "";
	}
	

	?><br>
	<h1 style="text-align: center ;color:#000066;">Welcome <?php echo $_SESSION['utype'];?><?php echo " ,"?><?php echo $_SESSION['ufirstname'];?><?php echo " "?><?php echo $_SESSION['ulastname'];?> <?php echo " "?>to Caramel IT Academy! </h1>
</div>
</body>
