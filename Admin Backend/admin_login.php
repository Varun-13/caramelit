      ...
      <div class="col-sm-9 col-md-7 col-lg-5 mx-auto">
        <div class="card card-signin my-5">
          ...
          <div class="card-body">
            ...
            <h2 class="card-title text-center"><b>Admin-Sign In</b></h2>
            ...
            <form class="form-signin"  method="post">
              ...
              <hr class="my-4">
               ...
               <a href="admin_register.php" style="font-size: 20px;">Sign Up</a><a class="float-right"  href="/user/forgot-password" style="font-size: 20px;">Forgot password?</a>
            </form>
          </div>
        </div>
      </div>
