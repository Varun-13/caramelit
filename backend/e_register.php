	...
	<div class="row">
		<div class="col-md-3"></div>
			<div class="col-md-6">
      			...
      			<h2 align=center style="color:#ADD8E6;"><b>University Registration</b></h2><br>
      				<div id="form">
      				<form autocomplete="off" action="e_register.php" method="post"  role="form" data-toggle="validator" id="reg-form">
